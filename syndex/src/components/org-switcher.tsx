...
export function OrgSwitcher() {
      ...
      <SidebarMenu>
        <SidebarMenuItem>
          <SidebarMenuButton size='lg' disabled>
            ...
            >
              <span className='truncate font-semibold'>SYNDEX</span>
  ...
  // Show SYNDEX branding with create organization option if no organizations
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuItem className='gap-2 p-2'>
                <div className='flex size-6 items-center justify-center overflow-hidden rounded-md border bg-primary'>
                  <DollarSign className='size-3.5 shrink-0 text-primary-foreground' />
                </div>
                Personal Account
